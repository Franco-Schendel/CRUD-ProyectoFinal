...
### Administrador
  ...
  Cuando se accede a la pagina con un usuario de tipo administrador, este es redirigido a `CRUD.html`. En esta página hay una tabla con todos los datos de cada pelicula y botones que permiten modificar los datos de la API (crear, editar y eliminar)
